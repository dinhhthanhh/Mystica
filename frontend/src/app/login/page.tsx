        ...
        <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
            <Card className="w-full max-w-md p-8 sm:p-10 space-y-8" glow>
                <div className="text-center space-y-2">
                    ...
                    <h1 className="text-3xl font-mystic font-bold">Chào mừng trở lại</h1>
                    <p className="text-sm text-foreground/60">Đăng nhập để tiếp tục hành trình tâm linh của bạn</p>
                </div>
                ...
                <p className="text-center text-sm text-foreground/60">
                    Chưa có tài khoản?{' '}
                    <Link href="/register" className="text-mystic-gold hover:underline">
                        Đăng ký ngay
                    </Link>
                </p>
            </Card>
